...
func _is_spot_valid(pos: Vector2) -> bool:
	...
	# 1. Locate your main container node named "PlacementZone"
	...
	if folder_node:
		...
		for child in folder_node.get_children():
			if child is CollisionPolygon2D:
				...
				# Convert our coordinate check position into the polygon's local workspace
...
func refresh_availability(val:bool):
	...
	modulate.a = 1.0 if available else 0.5
